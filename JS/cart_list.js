...
function compute_cart_count(num){
    var cart_number = get_local_storage("count");
    if(cart_number>0){
...
function show_goods_items(cart_items_barcade,local_items){
    ...
    show_shopping_little_price(local_items,cart_items_barcade);
}
function show_shopping_little_price(local_items,cart_items_barcade){
